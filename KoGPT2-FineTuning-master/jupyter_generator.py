...
def main(temperature = 0.7, top_p = 0.8, top_k = 40, tmp_sent = "", text_size = 100, loops = -1,
	load_path = './checkpoint/KoGPT2_checkpoint_long.tar', ctx= 'cuda', samples="/My Drive/KoGPT2-FineTuning_pre/samples/"):
	...
	kogpt2model.load_state_dict(torch.load(load_path))
    # kogpt2model.load_state_dict(checkpoint['model_state_dict'])
	tok_path = 'kobert_news_wiki_ko_cased-1087f8699e.spiece'

	kogpt2model.eval()
	vocab_b_obj = gluonnlp.vocab.BERTVocab.from_sentencepiece(tok_path,
															  mask_token=None,
															  sep_token=None,
															  cls_token=None,
															  unknown_token='[UNK]',
